...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger" style="background-color:#4d1522;color:white">
                        
                          <center> <h3><strong>Items Ordenados Anteriormente</strong> </h3></center>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
        ...
        echo "<tr>";
        echo "<td colspan='4' align='center' style='font-size:18px;'>"."Nombre Cliente: <span style='color:red;'>".$user_firstname." ".$user_lastname."</span>";
		
		//echo "<td colspan='4' align='center' style='font-size:18px;'>"."Customer Name: <span style='color:red;'>".$user_firstname." ".$user_lastname."</span> | "."Email: <span style='color:red;'>".$user_email."</span> | "."Direccion: <span style='color:red;'>".$user_address." </span>";
		echo "</td>";
		
		echo "<td>"."<a class='btn btn-danger' href='customers.php'><span class='glyphicon glyphicon-backward'></span>Regresar<a/>";
		echo "</td>";
	...
	else
	{
        ...
        <div class="col-xs-12">
        	<div class="alert alert-warning">
                <span class="glyphicon glyphicon-info-sign"></span> &nbsp; Aun no hay items pedidos ...
