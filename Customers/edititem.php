        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a data-toggle="modal" data-target="#uploadModal"> &nbsp; &nbsp; &nbsp; Añadir ingrediente</a></li>
					<li class="active"><a href="items.php"> &nbsp; &nbsp; &nbsp; Editar ingredientes</a></li>
					<li><a href="customers.php"> &nbsp; &nbsp; &nbsp; Editar usuarios</a></li>
