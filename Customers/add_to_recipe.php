 ...
 extract($_SESSION); 
	...
	if(isset($_GET['cart']) && !empty($_GET['cart']))
	{
      ...
      /*  $nropagina2= $id/8;
		...
		$stmt_edit = $DB_con->prepare('SELECT recetas.item_id, recetas.item_name, recetas.item_price, recetas.item_image, recetas.candisp, items.item_name as ing  FROM recetas, items, ing_receta WHERE recetas.item_id =:item_id');
...
<body>
 ...
 <form role="form" >
    ...
    <tr>
        ...
        <td><input class="form-control" type="hidden" name="v4" id="v4" value="<?php echo $nropagina1; ?>" disabled/></td>
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="v1" id="v1" value="<?php echo $item_name; ?>" disabled/></td>
	 ...
	 <tr>
        ...
        <td><input class="form-control" type="text" name="v2" id="v2" value="<?php echo $item_price; ?>" disabled/></td>
    </tr>
    
    
    <tr>
    	<td><label class="control-label">Ingredientes</label></td>
        <td><input class="form-control" type="text" name="v2" id="v2" value="<?php echo $ing; ?>" disabled/></td> <!-- AQUIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII -->
    </tr>

	 <tr>
    	<td><label class="control-label">Cantidad  Disponible.</label></td>
        <td><input class="form-control" type="text" name="v2" value="<?php echo $candisp; ?>" disabled/></td>
    </tr>
...
function myFunctionadd() {
    ...
    var v3 = document.getElementById('v3').value;      
            ...
            $.ajax({
                    ...
                    type: 'POST' ,
                    dataType: 'html',
                    data: {'user_id':Id_cliente,'order_name':v1,'order_price':v2,'order_quantity':v3,'item_id':item_id },
                })
